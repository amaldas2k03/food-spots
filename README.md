...
- **client/** — React 18 + Vite + Tailwind v4 + React Router v6 + Zustand
...
Requires [Docker Desktop](https://www.docker.com/products/docker-desktop/) (not currently installed on this machine).
...
- **Heatmap** — spot coordinates passed to the Google Maps heatmap layer, weighted by
  review count.
